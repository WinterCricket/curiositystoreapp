                       ...
                       //connect to data base
				        ...
				        if ($result = $mysqli->query("SELECT * FROM products ORDER BY id"))
				        {
				        	if ($result->num_rows != 0)
				        	{
						        ...
						        // display pagination
						        echo "<p><a href='curiousview.php'>View All</a> | <b>View Page:</b> ";
						        for ($i = 1; $i <= $total_pages; $i++)
						        {
						        	...
						        	{
						        		echo "<a href='curiouspaginated.php?page=$i'>$i</a> ";
						        	}
						        }
						        echo "</p>";
						        ...
						        for ($i = $start; $i < $end; $i++)
						        {
					                ...
					                echo '<td><a href="curiousdelete.php?id=' . $row[0] . '">Delete</a></td>';
					                echo "</tr>";
						        }
